...
<div class="logo">
	<a href="index.html">
	<img src="<?php echo base_url(); ?>assets/admin/pages/img/logo.png" alt="" style="width: 20%;"/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	<form class="login-form" action="<?php echo $url; ?>" method="post">
		...
		<div class="create-account">
			<p>
				 Aplikasi Laboratorium System &nbsp; <a href="javascript:;" id="register-btn">
				SYNGENTA </a>
			</p>
		</div>
	</form>
	...
	<form class="forget-form" action="<?php echo $url; ?>" method="post">
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2018 &copy; PT POTABOX INDONESIA.
</div>
<!-- END COPYRIGHT -->
