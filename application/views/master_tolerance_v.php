		...
		<div class="page-content">
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Master Data <small>Master Tolerance</small></h1>
				</div>
									...
									<div class="form-body">
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Percentage Germination</label>
												<span class="help-block">Input your name of percentage germination...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between Replication (4 Replicate 100)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between Replication (2 Replicate 100)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between Replication (2 Replicate 50)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between 2 Testing (4 Replicate 100)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between 2 Testing (2 Replicate 100)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between 2 Testing (2 Replicate 50)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between 3 Testing (4 Replicate 100)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between 3 Testing (4 Replicate 500)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between 4 Testing (4 Replicate 100)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your percentage">
												<label for="form_control_1">Tolerance Between 4 Testing (4 Replicate 50)</label>
												<span class="help-block">Input your of percentage ...</span>
											</div>
										</div>
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<th>
									 4 Test 2 Replicate 100
								</th>
								<th>
									 2 Test 2 Replicate 100
								</th>
								<th>
									 2 Test 2 Replicate 50
								</th>
								<th>
									 4 Test 3 Replicate 100
								</th>
								<th>
									 2 Test 3 Replicate 100
								</th>
								<th>
									 2 Test 3 Replicate 50
								</th>
								<th>
									 4 Test 4 Replicate 100
								</th>
								<th>
									 2 Test 4 Replicate 100
								</th>
								<th>
									 2 Test 4 Replicate 500
								</th>
								<th>
									 Action
								</th>
