									...
									<div class="form-body">
										...
										<div class="col-md-3">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your seed group">
												<label for="form_control_1">Seed Group</label>
												<span class="help-block">Input your name of seed group...</span>
											</div>
										</div>

										<div class="col-md-3">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your material group">
												<label for="form_control_1">Material Group</label>
												<span class="help-block">Input your name of material group...</span>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group form-md-line-input has-info">
