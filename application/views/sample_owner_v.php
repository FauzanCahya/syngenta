		...
		<div class="page-content">
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Master Data <small>Sample Owner</small></h1>
				</div>
									...
									<div class="form-body">
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your sample owner">
												<label for="form_control_1">Sample Owner</label>
												<span class="help-block">Input your name of sample owner...</span>
											</div>
										</div>
