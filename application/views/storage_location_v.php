		...
		<div class="page-content">
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Master Data <small>Material Group</small></h1>
				</div>
									...
									<div class="form-body">
										...
										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your storage location">
												<label for="form_control_1">Storage Location</label>
												<span class="help-block">Input your name of storage location...</span>
											</div>
										</div>

										<div class="col-md-4">
											<div class="form-group form-md-line-input">
												<input type="text" class="form-control" id="form_control_1" placeholder="Enter your storage code SAP">
												<label for="form_control_1">Storage Code SAP</label>
												<span class="help-block">Input your name of storage code SAP...</span>
											</div>
										</div>
										<div class="col-md-4">
														...
														<div class="form-group">
															...
															<div class="col-md-2">
																<select class="form-control">
																	...
																	<option>Storage Code SAP</option>
